...
/** Mithril-lynx component for the "cm" country flag (ISO 3166-1 alpha-2). */
const FlagCm = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#007a5e" d="M0 0h213.3v480H0z"/>
