...
/** Mithril-lynx component for the "bb" country flag (ISO 3166-1 alpha-2). */
const FlagBb = lynxIcon(`<path fill="#00267f" d="M0 0h640v480H0z"/>
  ...
  <use xlink:href="#bb-a" width="100%" height="100%" transform="matrix(-1 0 0 1 639.5 0)"/>`, _attrs, 640, 480)
