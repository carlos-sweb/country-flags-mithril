...
/** Mithril-lynx component for the "sv" country flag (ISO 3166-1 alpha-2). */
const FlagSv = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#0f47af" d="M0 0h640v480H0z"/>
