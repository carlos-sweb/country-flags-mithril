...
/** Mithril-lynx component for the "nc" country flag (ISO 3166-1 alpha-2). */
const FlagNc = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#009543" d="M0 0h640v480H0z"/>
