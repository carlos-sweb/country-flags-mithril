...
/** Mithril-lynx component for the "ck" country flag (ISO 3166-1 alpha-2). */
const FlagCk = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#006" d="M0 0h640v480H0z"/>
