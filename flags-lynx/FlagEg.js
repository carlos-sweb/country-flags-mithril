...
/** Mithril-lynx component for the "eg" country flag (ISO 3166-1 alpha-2). */
const FlagEg = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#000001" d="M0 320h640v160H0z"/>
