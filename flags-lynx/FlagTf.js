...
/** Mithril-lynx component for the "tf" country flag (ISO 3166-1 alpha-2). */
const FlagTf = lynxIcon(`<defs>
  ...
  <use xlink:href="#tf-a" width="100%" height="100%" x="499" y="227" transform="scale(1.2)"/>`, _attrs, 640, 480)
