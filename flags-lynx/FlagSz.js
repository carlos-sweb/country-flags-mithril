...
/** Mithril-lynx component for the "sz" country flag (ISO 3166-1 alpha-2). */
const FlagSz = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#3e5eb9" d="M0 0h640v480H0Z"/>
