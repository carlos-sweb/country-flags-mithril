...
/** Mithril-lynx component for the "tk" country flag (ISO 3166-1 alpha-2). */
const FlagTk = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#00247d" d="M0 0h640v480H0z"/>
