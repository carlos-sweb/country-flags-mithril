...
/** Mithril-lynx component for the "gq" country flag (ISO 3166-1 alpha-2). */
const FlagGq = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#e32118" d="M0 0h640v480H0z"/>
