...
/** Mithril-lynx component for the "kz" country flag (ISO 3166-1 alpha-2). */
const FlagKz = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#00abc2" d="M0 0h640v480H0z"/>
  <g fill="#ffec2d">
