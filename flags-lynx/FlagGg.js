...
/** Mithril-lynx component for the "gg" country flag (ISO 3166-1 alpha-2). */
const FlagGg = lynxIcon(`<path fill="#fff" d="M0 0h640v480H0z"/>
  ...
  <use xlink:href="#gg-a" width="36" height="24" transform="rotate(-90 320 240)"/>
  <use xlink:href="#gg-a" width="36" height="24" transform="rotate(180 320 240)"/>`, _attrs, 640, 480)
