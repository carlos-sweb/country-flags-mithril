...
/** Mithril-lynx component for the "mn" country flag (ISO 3166-1 alpha-2). */
const FlagMn = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#da2032" d="M0 0h640v480H0Z"/>
