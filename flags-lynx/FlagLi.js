...
/** Mithril-lynx component for the "li" country flag (ISO 3166-1 alpha-2). */
const FlagLi = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#002b7f" d="M0 0h640v240H0z"/>
