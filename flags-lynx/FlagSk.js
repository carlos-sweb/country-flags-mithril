...
/** Mithril-lynx component for the "sk" country flag (ISO 3166-1 alpha-2). */
const FlagSk = lynxIcon(`<path fill="#ee1c25" d="M0 0h640v480H0z"/>
  ...
  <path fill="#0b4ea2" d="M233 263.3c-19.9 0-30.5 27.5-30.5 27.5s-6-13-22.2-13c-11 0-19 9.7-24.2 18.8 20 31.7 51.9 51.3 76.9 63.4 25-12 57-31.7 76.9-63.4-5.2-9-13.2-18.8-24.2-18.8-16.2 0-22.2 13-22.2 13S253 263.3 233 263.3"/>`, _attrs, 640, 480)
