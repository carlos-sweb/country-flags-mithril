...
/** Mithril-lynx component for the "pt" country flag (ISO 3166-1 alpha-2). */
const FlagPt = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="red" d="M256 0h384v480H256z"/>
