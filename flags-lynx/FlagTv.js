...
/** Mithril-lynx component for the "tv" country flag (ISO 3166-1 alpha-2). */
const FlagTv = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#009fca" d="M0 0h640v480H0z"/>
