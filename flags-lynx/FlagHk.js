...
/** Mithril-lynx component for the "hk" country flag (ISO 3166-1 alpha-2). */
const FlagHk = lynxIcon(`<path fill="#EC1B2E" d="M0 0h640v480H0"/>
  ...
  <use xlink:href="#hk-a" transform="rotate(288 312.5 243.5)"/>`, _attrs, 640, 480)
