...
/** Mithril-lynx component for the "kh" country flag (ISO 3166-1 alpha-2). */
const FlagKh = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#032ea1" d="M0 0h640v480H0z"/>
