...
/** Mithril-lynx component for the "gr" country flag (ISO 3166-1 alpha-2). */
const FlagGr = lynxIcon(`<path fill="#0d5eaf" fill-rule="evenodd" d="M0 0h640v53.3H0z"/>
  ...
  <path fill="#0d5eaf" d="M0 426.7h640V480H0z"/>`, _attrs, 640, 480)
