...
/** Mithril-lynx component for the "ve" country flag (ISO 3166-1 alpha-2). */
const FlagVe = lynxIcon(`<defs>
  ...
  <use xlink:href="#ve-f" width="180" height="120" transform="rotate(-80 320 336)"/>`, _attrs, 640, 480)
