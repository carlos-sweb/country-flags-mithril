...
/** Mithril-lynx component for the "fj" country flag (ISO 3166-1 alpha-2). */
const FlagFj = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#68bfe5" d="M0 0v480h640V0z"/>
