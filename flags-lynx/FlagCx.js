...
/** Mithril-lynx component for the "cx" country flag (ISO 3166-1 alpha-2). */
const FlagCx = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#0021ad" d="M0 0h640v480H0z"/>
