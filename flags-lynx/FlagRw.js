...
/** Mithril-lynx component for the "rw" country flag (ISO 3166-1 alpha-2). */
const FlagRw = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#20603d" d="M0 0h640v480H0z"/>
