...
/** Mithril-lynx component for the "gd" country flag (ISO 3166-1 alpha-2). */
const FlagGd = lynxIcon(`<defs>
    <g id="gd-c">
      <g id="gd-b">
  ...
  <use xlink:href="#gd-d" width="100%" height="100%" x="100" transform="translate(30.3 414.6)"/>`, _attrs, 640, 480)
