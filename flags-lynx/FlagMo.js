...
/** Mithril-lynx component for the "mo" country flag (ISO 3166-1 alpha-2). */
const FlagMo = lynxIcon(`<path fill="#00785e" d="M0 0h640v480H0z"/>
  ...
  <use xlink:href="#mo-a" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)"/>`, _attrs, 640, 480)
