...
/** Mithril-lynx component for the "tc" country flag (ISO 3166-1 alpha-2). */
const FlagTc = {
  view: (vnode) => m(
    'svg',
    { ..._attrs(vnode.attrs?.width, vnode.attrs?.height), ...(vnode.attrs || {}), content: `<path fill="#002868" d="M640 480V0H0v480z"/>
